...
class IGFeedPostHeaderTableViewCell: UITableViewCell {
    ...
    weak var delegalte: IGFeedPostHeaderTableViewCellDelegate?
    ...
    override func layoutSubviews() {
        ...
        usernameLabel.frame = CGRect(x: profilePhotoImageView.right + 5, y: 2, width: contentView.width - (size*2) - 15, height: contentView.height - 4)
    }
