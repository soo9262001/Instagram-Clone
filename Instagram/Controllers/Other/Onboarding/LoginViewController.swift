...
class LoginViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        headerView.frame = CGRect(x: 0, y: 0.0, width: view.width, height: view.height/2.5)
    ...
    private func configureHeaderView() {
        ...
        imageView.frame = CGRect(x: headerView.width/4.0, y: view.safeAreaInsets.top, width: headerView.width/2.0, height: headerView.width - view.safeAreaInsets.top)
        }
